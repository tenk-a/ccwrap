# ccwrap: CMake toolchain for Open Watcom, 16-bit DOS, small model.
#
...
set(CMAKE_C_FLAGS   "-bt=dos -ms -k4000 ${CMAKE_C_FLAGS}")
set(CMAKE_CXX_FLAGS "-bt=dos -ms -k4000 ${CMAKE_CXX_FLAGS}")
