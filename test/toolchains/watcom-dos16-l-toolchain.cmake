# ccwrap: CMake toolchain for Open Watcom, 16-bit DOS, large model.
#
...
set(CMAKE_C_FLAGS   "-bt=dos -ml -k6000 ${CMAKE_C_FLAGS}")
set(CMAKE_CXX_FLAGS "-bt=dos -ml -k6000 ${CMAKE_CXX_FLAGS}")
