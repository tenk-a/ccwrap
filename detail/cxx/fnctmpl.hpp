...
#define _CCW_FNCTMPL_CM_TYPEARG_0
#define _CCW_FNCTMPL_CM_TYPEARG_1   ,_CCW_FNCTMPL_TYPEARG_1
#define _CCW_FNCTMPL_CM_TYPEARG_2   ,_CCW_FNCTMPL_TYPEARG_2
#define _CCW_FNCTMPL_CM_TYPEARG_3   ,_CCW_FNCTMPL_TYPEARG_3
#define _CCW_FNCTMPL_CM_TYPEARG_4   ,_CCW_FNCTMPL_TYPEARG_4
#define _CCW_FNCTMPL_CM_TYPEARG_5   ,_CCW_FNCTMPL_TYPEARG_5
#define _CCW_FNCTMPL_CM_TYPEARG_6   ,_CCW_FNCTMPL_TYPEARG_6
#define _CCW_FNCTMPL_CM_TYPEARG_7   ,_CCW_FNCTMPL_TYPEARG_7
#define _CCW_FNCTMPL_CM_TYPEARG_8   ,_CCW_FNCTMPL_TYPEARG_8
#define _CCW_FNCTMPL_CM_TYPEARG_9   ,_CCW_FNCTMPL_TYPEARG_9
#define _CCW_FNCTMPL_CM_TYPEARG_10 ,_CCW_FNCTMPL_TYPEARG_10

#define _CCW_FNCTMPL_FNCARG_MC_0
#define _CCW_FNCTMPL_FNCARG_MC_1   _CCW_FNCTMPL_FNCARG_1,
#define _CCW_FNCTMPL_FNCARG_MC_2   _CCW_FNCTMPL_FNCARG_2,
#define _CCW_FNCTMPL_FNCARG_MC_3   _CCW_FNCTMPL_FNCARG_3,
#define _CCW_FNCTMPL_FNCARG_MC_4   _CCW_FNCTMPL_FNCARG_4,
#define _CCW_FNCTMPL_FNCARG_MC_5   _CCW_FNCTMPL_FNCARG_5,
#define _CCW_FNCTMPL_FNCARG_MC_6   _CCW_FNCTMPL_FNCARG_6,
#define _CCW_FNCTMPL_FNCARG_MC_7   _CCW_FNCTMPL_FNCARG_7,
#define _CCW_FNCTMPL_FNCARG_MC_8   _CCW_FNCTMPL_FNCARG_8,
#define _CCW_FNCTMPL_FNCARG_MC_9   _CCW_FNCTMPL_FNCARG_9,
#define _CCW_FNCTMPL_FNCARG_MC_10 _CCW_FNCTMPL_FNCARG_10,
...
#define _CCW_FNCTMPL_FNCARG_MC(N)   _CCW_FNCTMPL_FNCARG_MC_##N
#define _CCW_FNCTMPL_CM_TYPEARG(N)  _CCW_FNCTMPL_CM_TYPEARG_##N
...
#define _CCW_FNCTMPL_FNCARG_MC(DMY)     _CCW_FNCTMPL_FNCARG(DMY) ,
#define _CCW_FNCTMPL_CM_TYPEARG(DMY)    , _CCW_FNCTMPL_TYPEARG(DMY)
