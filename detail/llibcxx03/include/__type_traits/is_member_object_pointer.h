...
//===----------------------------------------------------------------------===//
#ifndef _CCW_LIBCPP___TYPE_TRAITS_IS_MEMBER_OBJECT_POINTER_H
#define _CCW_LIBCPP___TYPE_TRAITS_IS_MEMBER_OBJECT_POINTER_H
#include "../__config"
...
template <class _Tp> struct _CCW_LIBCPP_TEMPLATE_VIS is_member_object_pointer
