...
static const __ph<1> _1 = __ph<1>();
static const __ph<2> _2 = __ph<2>();
static const __ph<3> _3 = __ph<3>();
static const __ph<4> _4 = __ph<4>();
static const __ph<5> _5 = __ph<5>();
static const __ph<6> _6 = __ph<6>();
static const __ph<7> _7 = __ph<7>();
static const __ph<8> _8 = __ph<8>();
static const __ph<9> _9 = __ph<9>();
} // namespace placeholders
