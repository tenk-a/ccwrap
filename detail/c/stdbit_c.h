/**
 *  @file   detail/c/stdbit_c.h
 *  @brief  The C form of <stdbit.h> (C23): the stdc_* bit-manipulation utilities.
 *  @license Boost Software License Version 1.0
 */
#ifndef _CCW_DETAIL_STDBIT_C_H
#define _CCW_DETAIL_STDBIT_C_H
...
static _ccw_forceinline _ccw_bool stdc_has_single_bit_##suffix(type value) \
