...
@echo       msys2,msys2clang,mingw32,watcom,dmc,orangec,djgpp
goto L_END
...
if /i "%CcName%"=="watcom_ccw" goto L_WATCOM_CCW
if /i "%CcName%"=="ow_ccw"     goto L_WATCOM_CCW
...
:L_DJGPC98_14
    set CcCompiler=djgpp-2.05-gcc-14.2-pc98
    goto L_DJGPP_SUB_MSYS2

:L_DJGPP14
    set CcCompiler=djgpp-2.05-gcc-14.2
    goto L_DJGPP_SUB_MSYS2

:L_DJGPP12
    set CcCompiler=djgpp-2.05-gcc-12.1
    goto L_DJGPP_SUB_MSYS2

:L_DJGPP10
    set CcCompiler=djgpp-2.05-gcc-10.2
    goto L_DJGPP_SUB_MSYS2

:L_DJGPP9
    set CcCompiler=djgpp-2.05-gcc-9.2
    goto L_DJGPP_SUB_MSYS2

:L_DJGPP_SUB_MSYS2
    if /i "%MSYS2_ROOT%"=="" set "MSYS2_ROOT=c:\msys64"
    if /i "%DJGPP_VER%"=="" set "DJGPP_VER=14.2.0"
    ::set "DJDIR=%MSYS2_ROOT%\usr\local\MinGW64\%CcCompiler%"
    set "DJDIR=%MSYS2_ROOT%\usr\local\ucrt64\%CcCompiler%"
    set "MSDOSDJGPP_ROOT=i386-pc-msdosdjgpp"
...
::L_DJGPP12
    set CcCompiler=djgpp-2.05-gcc-12.2
    set DJGPP_VER=12.2.0
    goto L_DJGPP_SUB_MINGW

::L_DJGPP10
    set CcCompiler=djgpp-2.05-gcc-10.3
...
:L_DJGPP8
    set CcCompiler=djgpp-2.05-gcc-8.3
    set DJGPP_VER=8.3.0
    goto L_DJGPP_SUB_MINGW

:L_DJGPP7
    set CcCompiler=djgpp-2.05-gcc-7.5
    set DJGPP_VER=7.5.0
    goto L_DJGPP_SUB_MINGW

:L_DJGPP6
    set CcCompiler=djgpp-2.05-gcc-6.5
    set DJGPP_VER=6.5.0
    goto L_DJGPP_SUB_MINGW
...
:L_DJGPP_SUB_MINGW
    if /i "%MINGW_ROOT%"=="" set "MINGW_ROOT=c:\MinGW"
    if /i "%DJGPP_VER%"=="" set "DJGPP_VER=14.2.0"
    set "DJDIR=%MINGW_ROOT%\usr\local\%CcCompiler%"
    set "MSDOSDJGPP_ROOT=i386-pc-msdosdjgpp"
