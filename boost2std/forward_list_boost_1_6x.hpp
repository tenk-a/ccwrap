...
#ifndef __CCWRAP_BOOST_CONTAINER_SLIST_HPP
#define __CCWRAP_BOOST_CONTAINER_SLIST_HPP
...
#define __ccwrap_dtl    dtl
#else
#define __ccwrap_dtl    container_detail
#endif

namespace __ccwrap_dtl {

template<class VoidPointer>
struct forward_list_hook
{
   typedef typename __ccwrap_dtl::bi::make_slist_base_hook
      <__ccwrap_dtl::bi::void_pointer<VoidPointer>, __ccwrap_dtl::bi::link_mode<__ccwrap_dtl::bi::normal_link> >::type type;
};

template <class T, class VoidPointer>
struct forward_list_node
   :  public forward_list_hook<VoidPointer>::type
{
   private:
   forward_list_node();
   ...
   typedef typename forward_list_hook<VoidPointer>::type hook_type;
...
template <class T, class VoidPointer>
struct iiterator_node_value_type< forward_list_node<T,VoidPointer> > {
  typedef T type;
};
   ...
   typedef typename boost::intrusive::pointer_traits
      <typename allocator_traits_type::pointer>::template
         rebind_pointer<void>::type
            void_pointer;
   typedef typename __ccwrap_dtl::forward_list_node
         <value_type, void_pointer>             node_type;

   typedef typename __ccwrap_dtl::bi::make_slist
      <node_type
      ,__ccwrap_dtl::bi::base_hook<typename forward_list_hook<void_pointer>::type>
      ,__ccwrap_dtl::bi::constant_time_size<true>
      , __ccwrap_dtl::bi::size_type
...
class forward_list
   : protected __ccwrap_dtl::node_alloc_holder
      <Allocator, typename __ccwrap_dtl::intrusive_slist_type<Allocator>::type>
{
   #ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   typedef typename
      __ccwrap_dtl::intrusive_slist_type<Allocator>::type           Icont;
   typedef __ccwrap_dtl::node_alloc_holder<Allocator, Icont>        AllocHolder;
   typedef typename AllocHolder::NodePtr                    NodePtr;
   typedef typename AllocHolder::NodeAlloc                  NodeAlloc;
   typedef typename AllocHolder::ValAlloc                   ValAlloc;
   typedef typename AllocHolder::Node                       Node;
   typedef __ccwrap_dtl::allocator_destroyer<NodeAlloc> Destroyer;
   ...
   BOOST_COPYABLE_AND_MOVABLE(forward_list)
   typedef __ccwrap_dtl::iterator_from_iiterator<typename Icont::iterator, false>  iterator_impl;
   typedef __ccwrap_dtl::iterator_from_iiterator<typename Icont::iterator, true >  const_iterator_impl;
   #endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   ...
   forward_list() BOOST_NOEXCEPT_IF(__ccwrap_dtl::is_nothrow_default_constructible<Allocator>::value)
      :  AllocHolder()
   {}
   ...
   //!
   //! <b>Complexity</b>: Constant.
   explicit forward_list(const allocator_type& a) BOOST_NOEXCEPT_OR_NOTHROW
      :  AllocHolder(a)
   {}
   ...
   //!
   //! <b>Complexity</b>: Linear to n.
   explicit forward_list(size_type n, const value_type& x, const allocator_type& a = allocator_type())
      :  AllocHolder(a)
   ...
   forward_list(InpIt first, InpIt last, const allocator_type& a =  allocator_type())
      : AllocHolder(a)
   ...
   forward_list(std::initializer_list<value_type> il, const allocator_type& a = allocator_type())
      : AllocHolder(a)
   ...
   //!
   //! <b>Complexity</b>: Constant.
   forward_list(BOOST_RV_REF(forward_list) x) BOOST_NOEXCEPT_OR_NOTHROW
   ...
   forward_list(BOOST_RV_REF(forward_list) x, const allocator_type &a)
      : AllocHolder(a)
   {
   ...
   {} //AllocHolder clears the forward_list
   ...
   forward_list& operator= (BOOST_COPY_ASSIGN_REF(forward_list) x)
   {
      if (&x != this){
         NodeAlloc &this_alloc     = this->node_alloc();
         const NodeAlloc &x_alloc  = x.node_alloc();
         __ccwrap_dtl::bool_<allocator_traits_type::
   ...
   forward_list& operator=(BOOST_RV_REF(forward_list) x)
   ...
   void assign(InpIt first, InpIt last
      ...
      , typename __ccwrap_dtl::disable_if_convertible<InpIt, size_type>::type * = 0
      #endif
      )
   {
   ...
   iterator insert_after(const_iterator prev_p, InpIt first, InpIt last
      #if !defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
      , typename __ccwrap_dtl::enable_if_c
         < !__ccwrap_dtl::is_convertible<InpIt, size_type>::value
          && (__ccwrap_dtl::is_input_iterator<InpIt>::value
                || __ccwrap_dtl::is_same<alloc_version, version_1>::value
               )
         >::type * = 0
      #endif
      )
   ...
   iterator insert_after(const_iterator prev, FwdIt first, FwdIt last
      , typename __ccwrap_dtl::enable_if_c
         < !__ccwrap_dtl::is_convertible<FwdIt, size_type>::value
            && !(__ccwrap_dtl::is_input_iterator<FwdIt>::value
                || __ccwrap_dtl::is_same<alloc_version, version_1>::value
               )
         >::type * = 0
      )
   ...
   void splice_after(const_iterator prev_p, forward_list& x) BOOST_NOEXCEPT_OR_NOTHROW
   {
      BOOST_ASSERT(this != &x);
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of
   //!    this list. Iterators of this list and all the references are not invalidated.
   void splice_after(const_iterator prev_p, BOOST_RV_REF(forward_list) x) BOOST_NOEXCEPT_OR_NOTHROW
   {  this->splice_after(prev_p, static_cast<forward_list&>(x));  }
   ...
   void splice_after(const_iterator prev_p, forward_list& x, const_iterator prev) BOOST_NOEXCEPT_OR_NOTHROW
   {
      BOOST_ASSERT(this->node_alloc() == x.node_alloc());
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice_after(const_iterator prev_p, BOOST_RV_REF(forward_list) x, const_iterator prev) BOOST_NOEXCEPT_OR_NOTHROW
   {  this->splice_after(prev_p, static_cast<forward_list&>(x), prev);  }
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice_after(const_iterator prev_p,      forward_list& x,
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice_after(const_iterator prev_p,      BOOST_RV_REF(forward_list) x,
      const_iterator before_first,  const_iterator before_last) BOOST_NOEXCEPT_OR_NOTHROW
   {  this->splice_after(prev_p, static_cast<forward_list&>(x), before_first, before_last);  }
   ...
   void splice_after(const_iterator prev_p,      BOOST_RV_REF(forward_list) x,
                     const_iterator before_first,  const_iterator before_last,
                     size_type n) BOOST_NOEXCEPT_OR_NOTHROW
   {  this->splice_after(prev_p, static_cast<forward_list&>(x), before_first, before_last, n);  }
   ...
   //! <b>Complexity</b>: This function is linear time: it performs at most
   //!   size() + x.size() - 1 comparisons.
   void merge(BOOST_RV_REF(forward_list) x)
   {  this->merge(static_cast<forward_list&>(x)); }
   ...
   void merge(forward_list& x, StrictWeakOrdering comp)
   {
   ...
   //! <b>Note</b>: Iterators and references to *this are not invalidated.
   template <class StrictWeakOrdering>
   void merge(BOOST_RV_REF(forward_list) x, StrictWeakOrdering comp)
   {  this->merge(static_cast<forward_list&>(x), comp); }
   ...
   {
      typedef value_to_node_compare<Node, StrictWeakOrdering> value_to_node_compare_type;
      // nothing if the forward_list has length 0 or 1.
      if (this->size() < 2)
         return;
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of
   //!    this list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, forward_list& x) BOOST_NOEXCEPT_OR_NOTHROW
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of
   //!    this list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, BOOST_RV_REF(forward_list) x) BOOST_NOEXCEPT_OR_NOTHROW
   {  this->splice(p, static_cast<forward_list&>(x));  }
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, forward_list& x, const_iterator i) BOOST_NOEXCEPT_OR_NOTHROW
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, BOOST_RV_REF(forward_list) x, const_iterator i) BOOST_NOEXCEPT_OR_NOTHROW
   {  this->splice(p, static_cast<forward_list&>(x), i);  }
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, forward_list& x, const_iterator first, const_iterator last) BOOST_NOEXCEPT_OR_NOTHROW
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, BOOST_RV_REF(forward_list) x, const_iterator first, const_iterator last) BOOST_NOEXCEPT_OR_NOTHROW
   {  this->splice(p, static_cast<forward_list&>(x), first, last);  }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   friend void swap(forward_list& x, forward_list& y)
   {  x.swap(y);  }
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<boost::container::forward_list<T, Allocator> >
{
   typedef typename ::boost::container::allocator_traits<Allocator>::pointer pointer;
...
template <class T, class Allocator>
class insert_iterator<boost::container::forward_list<T, Allocator> >
{
   private:
   typedef boost::container::forward_list<T, Allocator> Container;
   Container* container;
