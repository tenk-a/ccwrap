   ...
   :  public forward_list_hook<VoidPointer>::type
{
   ...
   BOOST_CONTAINER_FORCEINLINE ~forward_list_node()
...
struct intrusive_forward_list_type
{
   ...
   typedef typename boost::intrusive::pointer_traits
      <typename allocator_traits_type::pointer>::template
         rebind_pointer<void>::type
            void_pointer;
   typedef typename dtl::forward_list_node
         <value_type, void_pointer>             node_type;

   typedef typename dtl::bi::make_slist
      <node_type
      ,dtl::bi::base_hook<typename forward_list_hook<void_pointer>::type>
...
class forward_list
   : protected dtl::node_alloc_holder
      ...
      , typename dtl::intrusive_forward_list_type<typename real_allocator<T, Allocator>::type>::type>
{
   #ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   typedef typename real_allocator<T, Allocator>::type      ValueAllocator;
   typedef typename
      dtl::intrusive_forward_list_type<ValueAllocator>::type       Icont;
   ...
   forward_list() BOOST_NOEXCEPT_IF(dtl::is_nothrow_default_constructible<ValueAllocator>::value)
      :  AllocHolder()
   {}
...
forward_list(InpIt, InpIt) ->
   forward_list<typename iterator_traits<InpIt>::value_type>;

template <typename InpIt, typename Allocator>
forward_list(InpIt, InpIt, Allocator const&) ->
   forward_list<typename iterator_traits<InpIt>::value_type, Allocator>;
...
{
   typedef typename boost::container::forward_list<T, Allocator>::allocator_type allocator_type;
...
class insert_iterator<boost::container::forward_list<T, ValueAllocator> >
{
   private:
   typedef boost::container::forward_list<T, ValueAllocator> Container;
   Container* container;
