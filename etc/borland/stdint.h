/**
 *  @file   stdint.h
 *  @brief  stdint(typedef int??_t) for borland-c(<=5.5?)
 *  @date   2000-2017
 *  @author Masashi Kitamura (tenka@6809.net)
 *  @note
 *   -	public domain software
 */
#ifndef __CWRAP_STDINT_H
#define __CWRAP_STDINT_H
...
#include <../crtl/stdint.h>
#elif __BORLANDC__ >= 0x5600
...
#if 1 //!defined(__CCWRAP_NO_INT64)
...
#define INT64_C(val)	    (INT64_MAX - INT64_MAX + (val))
#define UINT64_C(val)	    (UINT64_MAX - UINT64_MAX + (val))
