...
namespace ccwrap {
 ...
 #if __CCWRAP__ != 1/*__CCWRAP_FAKE_STD*/ && !defined(__CCWRAP_HAS_CHAR8_T) && !defined(__cpp_char8_t)
...
namespace ccwrap {
 ...
 #if (__cplusplus >= 202000L || defined(CCWRAP_CXX20) || __CCWRAP__ == 1/*FAKE_STD*/ || __CCWRAP__ == 3/*b2s*/)
    using std::u8string;
