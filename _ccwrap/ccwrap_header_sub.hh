...
#ifndef __CCWRAP__
#define __CCWRAP__ 1 // __CCWRAP_ID_FAKE_STD
#endif
...
//#ifndef __CCWRAP_NAMESPCE_REPLACE_WITH_STD
//#define __CCWRAP_NAMESPCE_REPLACE_WITH_STD  1
//#endif
...
#elif defined _WIN32
 #define __CCWRAP_IS_MEM_ADDR(p)  ((char const*)(p) >= (char const*)std::size_t(0x10000) && (char const*)(p) <= (char const*)std::size_t(0xF0000000))
#elif __CCWRAP_CPU_BIT == 64
 #define __CCWRAP_IS_MEM_ADDR(p)  ((char const*)(p) >= (char const*)std::size_t(0x100)  && (char const*)(p) <= (char const*)std::size_t(0xFFFFffffFFFFff00))
#else
